from function import pygame, WINDOW_WIDTH, WINDOW_HEIGHT, WHITE, BLACK, RED, GRAY
...
class DeletePage(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # input boxes
        self.name = InputBox(self.x + 100, self.y + 10, 200, DeletePage.inputBoxHieght, DeletePage.inputBoxBackgroundColor, DeletePage.inputBoxTextSize, BLACK, "name")      # criminal basic information

        self.year =     InputBox(self.x + 400, self.y + 10, 80, DeletePage.inputBoxHieght, DeletePage.inputBoxBackgroundColor, DeletePage.inputBoxTextSize, BLACK, "year")     # time of the crime
